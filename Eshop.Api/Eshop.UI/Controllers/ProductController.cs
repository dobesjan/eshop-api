...
namespace Eshop.UI.Controllers
{
    public class ProductController : EshopBaseController
    {
        ...
        public ProductController(ILogger<ProductController> logger, ICategoryService categoryService, IProductService productService, ICustomerService customerService) : base(customerService, logger)
        {
            _logger = logger;
